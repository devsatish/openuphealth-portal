...
const footerLinks = {
  ...
  Support: [
    ...
    { href: "/app/help/crisis-support", label: "Crisis Resources" },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} OpenUp Health. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
            If you are in crisis, call <strong>988</strong> (Suicide & Crisis Lifeline) or text <strong>HOME</strong> to <strong>741741</strong>.
          </p>
        </div>
      </div>
    </footer>
